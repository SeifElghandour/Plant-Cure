...
function buildOtpEmailHtml(name, otp) {
  return `
    <div style="font-family: Arial, sans-serif; max-width: 520px; margin: 0 auto; color: #1a1a1a;">
      <h2 style="color: #2d8a6b; margin-bottom: 8px;">Doctor Plant AI</h2>
      <p>Hello ${name},</p>
      <p>Use the verification code below to complete your Doctor Plant AI account setup:</p>
      ...
      <p style="color: #888; font-size: 13px;">If you did not create a Doctor Plant AI account, you can safely ignore this email.</p>
    </div>
  `;
}
...
const sendEmail = async (options) => {
  ...
  const mailOptions = {
    from: `"Doctor Plant AI" <${process.env.EMAIL_USERNAME}>`,
    to: options.email,
